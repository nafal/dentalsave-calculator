                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><i class=""></i> Id</th>
                            <th class="hidden-phone"><i class=""></i> Name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php $status = $dat->status; ?>
                            @if($dat->status='1')
                            <td><span class="label label-info label-mini"> Active</span></td>
                            @else
                            <td><span class="label label-warning label-mini"> Inactive </span></td>
                            @endif
                            <td>

                                <a href="{{ route('edit', $dat->id) }}"> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
